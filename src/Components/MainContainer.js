      ...
      <div className='md:hidden px-5 py-2 '>
       ...
       <div className='flex justify-center'>
        ...
        <div className='z-10 absolute bottom-1/3 ml-20'>
              ...
              <div>
                <button className='bg-white text-black py-1 px-4 rounded-sm mt-2'>▶️ Play</button>
                <button className='bg-gray-600 text-white bg-opacity-70 py-1 mx-5 px-4 rounded-sm mt-2'>More Info</button>
              </div>
          </div>
